...
public class ControlledRunnableEvent extends EventObject {
  ...
  public static enum StateType {
    /**
     * The run state has changed. Either running started, stop requested or stopped.
     * 
     */
    RUN,

    /**
     * The pause state has changed. Either pausing requested, paused or not paused any more.
     * 
     */
    PAUSE,
  ...
  public StateTypeDetail getStateTypeDetail() {
    ...
    switch (stateType) {
      ...
      default:
        throw new ControlledRunnableError("Unknown state type "
            + stateType);
    }
